...
class StreamRecorder():
    ...
    def _create_recording_bin(self):
        ...
        recording_bin.add_pad(Gst.GhostPad.new(
            'recording_sink', queue.get_static_pad('sink')))
    ...
    def _create_listening_bin(self):
        ...
        listening_bin.add_pad(Gst.GhostPad.new(
            'listening_sink', queue.get_static_pad('sink')))
